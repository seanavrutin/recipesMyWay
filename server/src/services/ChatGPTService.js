...
את החלק של "קטגוריה" תבחר מתוך הרשימה הבאה: קינוחים,בשר,טופו,דגים,סלטים,מרקים,תוספות,פשטידות,מאפים. כך שכל מתכון יקבל קטגוריה אחת או יותר, מופרדות על ידי פסיקים. אם לא מצויינות כמויות למרכיבים, הפעל הגיון בריא והשלם לבד, אך ורק אם זה מובן מאילו מאיך שהטקסט כתוב.
