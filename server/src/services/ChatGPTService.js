...
את החלק של "קטגוריה" תבחר מתוך הרשימה הבאה: מרקים,סלטים,מנות עיקריות,תוספות,מאפים,קינוחים,לחמים,ארוחות בוקר,משקאות,חטיפים,פסטה,פיצות,דגים,עוף,בקר,טבעוני,צמחוני,ללא גלוטן,חגים. כך שכל מתכון יקבל קטגוריה אחת או יותר, מופרדות על ידי פסיקים.
